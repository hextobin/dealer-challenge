...
Car.find_or_create_by(year: "2007", make: "Toyota", model: "Corolloa", vin: "R0LL1NG1NSTYLE", color: "Gray", body_style: "Sedan")
...
Staff.find_or_create_by(first_name: "Kira", last_name: "Nerys")
